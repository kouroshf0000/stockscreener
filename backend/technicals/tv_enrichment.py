...
async def fetch_tv_analysis(
    ...
    """Single-interval (1D) analysis — used by the existing valuation pipeline."""
    try:
...
async def fetch_tv_multiframe(
    ...
    """
    Fetch multiple timeframes for swing or day trading signal generation.
    Swing: 1D + 4H + 1H
    Day:   4H + 1H + 15m
    Returns dict keyed by interval label — missing intervals are omitted.
    """
